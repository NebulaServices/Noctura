...
var _ = (function () {
  ...
  quick.edit = function (elem, text) {
    if (typeof elem === "string")
      return (document.querySelector(elem).innerHTML = text);
    elem.innerHTML = text;
  };
  ...
  quick.addClass = function (elem, classname) {
    ...
    if (typeof elem === "string")
      return document.querySelector(elem).classList.add(classname);
  ...
  quick.setCSS = function (elem, prop, value) {
    ...
    if (typeof elem === "string")
      return document.querySelector(elem).style.setProperty(prop, value);
    elem.style.setProperty(prop, value);
  };

  quick.hide = function (elem) {
    if (typeof elem == "string")
      return (document.querySelector(elem).style.display = "none");
    elem.style.display = "none";
  };

  quick.show = function (elem) {
    if (typeof elem == "string")
      return document.querySelector(elem).style.removeProperty("display");
  };
